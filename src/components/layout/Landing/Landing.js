...
import "../../../App.css";
import logo from "./rgukt-logo2.png";
          ...
          <div className="row justify-content-center">
            <div className="col-md-5 text-center">
              ...
              <p>
                ...
                <br />
                <i className="fas fa-phone "></i> 08752-255111 |{" "}
                <i className="fas fa-print"></i> +91-9492301902.
                <br />
                <i className="fas fa-envelope"></i> rkvalley@rguktrkv.ac.in
              </p>
            </div>
          </div>
        </footer>
